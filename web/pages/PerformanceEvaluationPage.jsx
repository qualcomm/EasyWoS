...
const PerformanceEvaluationPage = () => {
    ...
    useEffect(() => {
        const fetchMarkdown = async () => {
            try {
                // Fetching from the static path served by backend
                // Since app.static('/', 'dist'), the file at dist/static/... is at /static/...
                const response = await fetch('/static/performance_evaluation-en.md');
                if (response.ok) {
